...
public class SynchronizedMutableBagMultimapTest extends AbstractMutableBagMultimapTestCase
{
    @Override
    public <K, V> MutableBagMultimap<K, V> newMultimap()
    {
        return new SynchronizedMutableBagMultimap<>(HashBagMultimap.newMultimap());
    }
    ...
    {
        return new SynchronizedMutableBagMultimap<>(HashBagMultimap.newMultimap(pairs));
    }

    @Override
    public <K, V> MutableBagMultimap<K, V> newMultimapFromPairs(Iterable<Pair<K, V>> inputIterable)
    {
        return new SynchronizedMutableBagMultimap<>(HashBagMultimap.newMultimap(inputIterable));
    }
