...
public class SynchronizedMutableSetMultimapTest extends AbstractMutableSetMultimapTestCase
{
    @Override
    public <K, V> MutableSetMultimap<K, V> newMultimap()
    {
        return new SynchronizedMutableSetMultimap<>(UnifiedSetMultimap.newMultimap());
    }
    ...
    {
        return new SynchronizedMutableSetMultimap<>(UnifiedSetMultimap.newMultimap(pairs));
    }

    @Override
    public <K, V> MutableSetMultimap<K, V> newMultimapFromPairs(Iterable<Pair<K, V>> inputIterable)
    {
        return new SynchronizedMutableSetMultimap<>(UnifiedSetMultimap.newMultimap(inputIterable));
    }
