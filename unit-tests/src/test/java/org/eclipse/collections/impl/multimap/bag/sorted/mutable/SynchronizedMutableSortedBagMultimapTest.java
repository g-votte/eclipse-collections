...
public class SynchronizedMutableSortedBagMultimapTest extends AbstractMutableSortedBagMultimapTestCase
{
    @Override
    protected <K, V> MutableSortedBagMultimap<K, V> newMultimap(Comparator<V> comparator)
    {
        return new SynchronizedMutableSortedBagMultimap<>(TreeBagMultimap.newMultimap(comparator));
    }

    @Override
    public <K, V> MutableSortedBagMultimap<K, V> newMultimap()
    {
        return new SynchronizedMutableSortedBagMultimap<>(TreeBagMultimap.newMultimap());
    }
    ...
    {
        return new SynchronizedMutableSortedBagMultimap<>(TreeBagMultimap.newMultimap(pairs));
    }

    @Override
    public <K, V> MutableSortedBagMultimap<K, V> newMultimapFromPairs(Iterable<Pair<K, V>> inputIterable)
    {
        return new SynchronizedMutableSortedBagMultimap<>(TreeBagMultimap.newMultimap(inputIterable));
    }
