...
public class SynchronizedMutableListMultimapTest extends AbstractMutableListMultimapTestCase
{
    @Override
    public <K, V> MutableListMultimap<K, V> newMultimap()
    {
        return new SynchronizedMutableListMultimap<>(FastListMultimap.newMultimap());
    }
    ...
    {
        return new SynchronizedMutableListMultimap<>(FastListMultimap.newMultimap(pairs));
    }

    @Override
    public <K, V> MutableListMultimap<K, V> newMultimapFromPairs(Iterable<Pair<K, V>> inputIterable)
    {
        return new SynchronizedMutableListMultimap<>(FastListMultimap.newMultimap(inputIterable));
    }
